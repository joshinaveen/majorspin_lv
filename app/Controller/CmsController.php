...
class CmsController extends AppController {
	...
	function admin_page_section($cms_id=null){
    			...
    			if(!empty($ids)){
    				switch ($action) {
    					case 'delete':
    						...
    						$this->Session->setFlash(__('Selected '.$userC.' deleted',true),'default',array('class'=>'alert alert-success'));
    						return $this->redirect(array('controller'=>'cms','action'=>'page_section','admin'=>true,$cms_id));
    	...
    	$this->paginate = array('conditions'=>array('SubPage.cms_id'=>$cms_id),
                            'limit' => $this->limit
                            );
