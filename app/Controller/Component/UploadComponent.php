 ...
 * return : null
 */
 function remove( $filename, $dir_path)
 {
	...
	foreach ( $this->thumb as $thumb_img)
	{
 	...
 	/**
	 * Method Name : _rm_dir_file()
	 * Author Name : Vivek Kumar
	 * Creation Date : 16-12-2012
	 * Description : is Used to remove file from directory.
	 */
	function _rm_dir_file($dir)
	{
	...
	/**
	* Method Name : _rrm_dir()
	* Author Name : Vivek Kumar
	* Creation Date : 17-12-2012
	* Description : is Used to recursively remove the directory.
	*/

	function _rrm_dir($dir)
	{
		foreach(glob($dir . '/*') as $file)
		{
			if(is_dir($file))
	 ...
	 /**
	* Method Name : Move files from one directory to another
	* Author Name : Rupesh Sharma
	* Creation Date : 31-03-2014
	* Description : is Used to upload pdf file.
	*/

 function mov_files($source,$destination)
	 {
